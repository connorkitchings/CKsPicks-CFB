...
export default function MethodologyPage() {
  return <main className="mx-auto w-full max-w-4xl flex-1 space-y-6 px-4 py-8 text-sm leading-relaxed text-ink-muted">
    ...
    <section className="rounded-xl border border-line bg-surface-card p-5"><h2 className="text-lg font-semibold text-ink">Reading the record</h2><p className="mt-2">The V5 model was fit through the 2025 season. Its 2026 forecasts use only information available before each game; 2026 outcomes do not retrain the model. Market comparison uses timestamped lines after the model forecast; missing eligible lines yield no grade.</p></section>
