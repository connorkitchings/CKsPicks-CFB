            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="space-y-2">
                  <div className="h-4 w-24 animate-pulse rounded bg-surface-inset motion-reduce:animate-none" />
                  <div className="h-4 w-20 animate-pulse rounded bg-surface-inset motion-reduce:animate-none" />
                </div>
              </div>
            </div>
          ))}
