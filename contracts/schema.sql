...
CREATE TABLE IF NOT EXISTS predictions (
    ...
    regime                    TEXT NOT NULL CHECK (regime IN ('preseason', 'one_game', 'two_games', 'three_games', 'game_1', 'game_2', 'game_3', 'game_4', 'established')),
...
-- Diagnostic-only, reconstructed historical comparison context. This table is
-- deliberately isolated from prediction_runs, prediction_grades, and system_stats.
