...
| Contract | Status and dependency |
| --- | --- |
| 11B: [Possession ratings rebuild from r9](2026-09-21/03-v5-11b-possession-ratings-r9-rebuild.md) | **In Progress.** Entry: certified r9 measurements. Swap two ratings-layer pins, re-run the 60-candidate grid, verify independently; selection may flip and is user-reviewed before 11C. |
