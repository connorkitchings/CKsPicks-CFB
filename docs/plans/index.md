...
| 02 (Market study): [2025 market-line diagnostic study](2026-09-21/02-v5-2025-market-line-diagnostic-study.md) | **Approved 2026-09-21.** V5-only diagnostic comparison of 11A-verified conditional 2025 forecasts against replay provider-recorded lines (`market_snapshots` `e4061aab...`, read as raw quarantined bytes); labeled `diagnostic_comparison_only`, no readiness effect. Awaits Terra execution. |
