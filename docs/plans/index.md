...
| 01 (Corrective): [Foundation corrective rebuild](2026-09-21/01-v5-foundation-corrective-rebuild.md) | **Draft.** Replaces Repair verifier with producer-independent verifier (Finding 001) and fixes 5 measurement score-ledger causes in `r7` (Finding 003); closes both blockers in 10B. |
