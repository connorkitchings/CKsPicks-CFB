...
| 04B: [Calibration and certification](2026-09-17/02-v5-forecast-calibration-and-certification.md) | **Implemented (resolved 2026-09-21).** The September 17 artifact remains historical evidence; full Contract 11 independently reconstructed all outputs including final-fit rows on the r9 descendant line. |
...
| 12: [Historical results and readiness review](2026-09-18/12-v5-historical-results-and-readiness-review.md) | **Approved 2026-09-21 (Amendment 2).** Detailed execution approved under [06-v5-12](2026-09-21/06-v5-12-historical-results-and-readiness-review.md). Recomputes metrics from 11D verified dataset, incorporates horizon/head/market/V4 evidence, publishes Preview R2 scorecard, and issues readiness recommendation. |
...
| 11C: [Forecast bridge rebuild and through-2025 final fit](2026-09-21/04-v5-11c-forecast-bridge-and-final-fit.md) | **Implemented 2026-09-21.** Run `forecast-v1-20260921-5afd577-11c` (manifest SHA `2a55cd07...`): horizon `expanding`, reference heads, final rows per target (`training_max = 2025`); `final_fit_existence` passes on targeted re-run. 11D verification target. |
| 11D: [Forecast verification and findings closure](2026-09-21/05-v5-11d-forecast-verification-and-finding-closure.md) | **Implemented 2026-09-21.** Verifier re-pointed at r9-derived parents with hand-written final-fit reconstruction; umbrella Task 3 battery green; signed verification (`4cfe5ef8...`) + targeted closure of 002/004; umbrella 11 closed. |
