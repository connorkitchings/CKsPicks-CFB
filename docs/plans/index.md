...
| 11A: [Conditional forecast verification](2026-09-19/11a-v5-conditional-forecast-verification.md) | **In Progress.** Verifier code and real-artifact no-write reconstruction are complete; clean-SHA Preview evidence, independent re-read, and idempotent repeat remain. It grants only `conditional_historical_results_only`. |
