...
5. **Best-quote line policy (`model_side_best_quote_v1`) — live on the public site (2026-09-26).** The `prediction_market_selections` schema (migration 0016) is applied on both branches; future runs select the best pre-kickoff executable quote per target before freezing. All five 2026 weeks serve best-quote replacement runs (`2026w{0..4}-v5replay-bestquote-20260926-r2`, authorized under `v5-bestquote-replacement-review-2026-09-26`): forecasts identical to the prior selected runs, every line a real market tick, 281 W0–3 grades settled at the exact selected quotes (sub-threshold totals ungraded by design). W4 is published 58/58 and unscored pending its certified finals. V4 and the original V5 replay runs stay frozen/scored as audit records and rollback targets. See the [selection contract](../plans/2026-09-25/03-permanent-best-quote-line-selection.md) (Implemented) and the [release contract](../plans/2026-09-26/01-v5-bestquote-production-release.md).
