...
| 11A | [Conditional forecast verification](../plans/2026-09-19/11a-v5-conditional-forecast-verification.md) | In Progress — verifier code and exact no-write reconstruction are complete; clean-SHA Preview certification remains. Its only permitted use is `conditional_historical_results_only`; it does not restore eligibility. |
