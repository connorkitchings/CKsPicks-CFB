...
| P3 | Evaluate drives, advanced stats, ratings, PPA/WP, and WEPA in point-in-time historical experiments. | Expands candidate features and independent validation sources. | Tier 2 unchanged | 2022–2024 temporal selection, locked 2025 test, no full-season or postgame leakage. | **Research first.** |
