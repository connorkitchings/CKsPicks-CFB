...
> **Note:** This file has been consolidated into [`AGENTS.md`](./AGENTS.md)

For AI assistant guidance when working with this repository, please refer to **AGENTS.md** which is the universal entry point for all AI coding assistants (Claude Code, GitHub Copilot, Cursor, Gemini Code Assist, etc.).
...
- 🔗 **Quick Links** - Essential files and documentation
